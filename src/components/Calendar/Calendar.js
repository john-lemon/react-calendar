...
import {nominativeMonthNames, monthNames, shortDayNames} from 'const/const.js'
...
class Calendar extends React.Component {
  ...
  get value () {
    return `${this.state.selectedDay} ${this.state.selectedMonthGen} ${this.state.selectedYear}`
  }
  ...
  componentWillMount () {
    ...
    this.state.selectedMonthGen =  monthNames[this.state.selectedMonthIndex]
  ...
  _onSetMonth (index, monthName) {
    this.setState({
      ...
      selectedMonthGen: monthNames[index]
    },() => {
